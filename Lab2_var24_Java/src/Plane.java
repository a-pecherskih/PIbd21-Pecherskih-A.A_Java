...
public class Plane extends Vehicle {
	...
	protected void drawLightPlane(Graphics g)
    {
        ...
        g.drawOval(startPosX + 69, startPosY + 44, 21, 16); // îáâîäêà ïåðåäà
        g.setColor(super.getColorBody());
        g.fillOval(startPosX + 70, startPosY + 45, 20, 15); //ïåðåä
        g.setColor(Color.BLACK);
        g.drawRect(startPosX + 54, startPosY + 19, 16, 66); // îáâîäêà êðûëüåâ
        g.setColor(super.getDopColor());
        g.fillRect(startPosX + 55, startPosY + 20, 15, 65); //êðûëüÿ 
        g.setColor(Color.BLACK);
        g.drawRect(startPosX-1, startPosY + 44, 81, 16); // îáâîäêà îñíîâû
        g.setColor(super.getColorBody());
        g.fillRect(startPosX, startPosY + 45, 80, 15); //îñíîâíàÿ ëèíèÿ
        g.setColor(Color.BLACK);
        g.drawRect(startPosX - 1, startPosY + 34, 11, 36); // îáâîäêà çàäà
        g.setColor(super.getDopColor());
        g.fillRect(startPosX, startPosY + 35, 10, 35); //çàä
    }
}
